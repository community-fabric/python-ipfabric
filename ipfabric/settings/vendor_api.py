...
from ipfabric.settings.vendor_api_models import AWS, Azure, CheckPointApiKey, CheckPointUserAuth, \
    CiscoFMC, Merakiv0, NSXT, SilverPeak, Versa, Viptela

API_MODELS = Union[AWS, Azure, CheckPointApiKey, CheckPointUserAuth, CiscoFMC, Merakiv0, NSXT, SilverPeak, Versa,
                   Viptela]
